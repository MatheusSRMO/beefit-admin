...
export default function SideBar({ labels, className }: SideBarProps) {
  ...
  return (
    <aside className={cn('h-full w-48 bg-slate-500 rounded-r-[50px] bg-gradient-to-t to-[#192C64] from-[#120E44] flex justify-between flex-col items-center py-10 px-10', className)}>
